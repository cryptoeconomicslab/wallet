...
import { getTokenName, getTokenMaxDigits } from '../helpers/utils'
...
const Heading = ({
  ...
  React.useEffect(() => {
    function updater() {
      setBalanceInner(getTokenMaxDigits(tokenId, wallet.getBalance(tokenId)))
    }
  ...
  useEffectOnce(() => {
    wallet
      .syncChildChain()
      .then(() => setBalanceInner(getTokenMaxDigits(tokenId, wallet.getBalance(tokenId))))
  })
